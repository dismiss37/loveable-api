...
def majorlogin_jwt():
    ...
    # ✅ Multi‑threaded platform loop (20 workers)
...
# ✅ Bulk POST endpoint (JSON array) – unchanged
...
# ✅ New: GET /bulk-token with uid & password (same as /token)
# This line makes the oauth_guest function also respond to /bulk-token GET
